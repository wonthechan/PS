...
/*
 * Pos클래스 대신 2차원배열을 1차원배열로 나타내는 
 * 아나칼아모칼(알칼제이)기법을 통해 다시 풀어봄.
 */
public class Main_B16236_아기상어_아나칼아모칼 {
		...
		while(!queue.isEmpty()) {
			...
			while (size-- > 0) {
				...
				for (int dir = 0; dir < 4; dir++) {
					int ny = out / N + dy4[dir];
					int nx = out % N + dx4[dir];
